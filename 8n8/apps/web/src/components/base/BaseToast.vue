<template>
  <Teleport to="body">
    <div class="fixed top-0 end-0 z-50 p-4 space-y-4 w-full max-w-sm">
...
const toastClasses = (type: ToastType) => {
  switch (type) {
    ...
    case 'warning':
      return 'bg-yellow-600/20 border-yellow-500 text-yellow-100'
    case 'info':
      return 'bg-blue-600/20 border-blue-500 text-blue-100'
    default:
      return 'bg-gray-600/20 border-gray-500 text-gray-100'
  }
}
</script>
